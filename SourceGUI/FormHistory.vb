...
Public Class FormHistory
    ...
    Private Sub LoadHistoryGridData()
        ...
        '  !!! Изменено на GetAllSortHistoryData !!!
        Dim historyData As DataTable = DatabaseHelper.GetAllSortHistoryData()
        ...
        If historyData IsNot Nothing Then
            ...
            If dgvHistory.Columns.Contains("Timestamp") Then
                dgvHistory.Columns("Timestamp").HeaderText = "Date"
                dgvHistory.Columns("Timestamp").AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
            End If

            ' !!!  Добавляем новые столбцы для массивов !!!
            If Not dgvHistory.Columns.Contains("OriginalArrayColumn") Then
                Dim originalColumn As New DataGridViewTextBoxColumn()
                originalColumn.Name = "OriginalArrayColumn"
                originalColumn.HeaderText = "Исходный массив"
                originalColumn.DataPropertyName = "OriginalArray"  ' Привязка к столбцу DataTable
            End If

            If Not dgvHistory.Columns.Contains("SortedArrayColumn") Then
                Dim sortedColumn As New DataGridViewTextBoxColumn()
                sortedColumn.Name = "SortedArrayColumn"
                sortedColumn.HeaderText = "Отсортированный массив"
                sortedColumn.DataPropertyName = "SortedArray"    ' Привязка к столбцу DataTable
            End If
